...
| **16/05 → 22/05** | • Detectar carros e pessoas na maquete com OpenCV ✅<br>• Fazer o outro semáforo ✅<br>• Pensar integração da eletrônica + display + microcontroladores<br>• Começar o ML (dataset → decisão do farol)                                                       |
